...
export default function App() {
  ...
  useEffect(() => {
    ...
    authApi.getAppConfig().then(async (config: { demo_mode?: boolean; has_maps_key?: boolean; version?: string; timezone?: string; require_mfa?: boolean; permissions?: Record<string, PermissionLevel> }) => {
